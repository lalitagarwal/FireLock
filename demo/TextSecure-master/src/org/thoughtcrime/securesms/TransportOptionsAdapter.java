  ...
  public View getView(int position, View convertView, ViewGroup parent) {
    ...
    imageView.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        /*Intent pinlock= new Intent(v.getContext(), PinLock.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        pinlock.putExtra("category", "imm_trans");
        v.getContext().startActivity(pinlock);*/
      }
    });
